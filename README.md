...
### Pipelines
The current MitoEdit workflow incorporates four pipelines to predict target windows for a specific base. For more information about each pipeline click on the pipelines:
...
### TALE-NT Tool
The workflow uses the [TALE-NT tool](https://academic.oup.com/nar/article/40/W1/W117/1752530) to identify efficient flanking TALE arrays around the specified target position for each target window as applicable.
