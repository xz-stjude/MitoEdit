...
class Mok2020G1333Pipeline:
    """Pipeline for Mok2020 G1333 base editing approach (C→T and G→A edits)"""
    ...
    def process_mtDNA(self, mtDNA_seq, pos):
        ...
        if pos in C_positions:
            ...
            # Generate editing windows of different sizes (similar to G1397 but with G1333-specific positioning)
            for window_size in range(14, 21):  # 14-20bp windows
                for position_in_window in range(3, window_size - 2):  # Different positioning logic for G1333
